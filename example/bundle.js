...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(155);
	
	var _VariableText = __webpack_require__(158);
	
	var _VariableText2 = _interopRequireDefault(_VariableText);
	
	var _VariableHeight = __webpack_require__(182);
	
	var _VariableHeight2 = _interopRequireDefault(_VariableHeight);
	
	var _FixedHeight = __webpack_require__(183);
	
	var _FixedHeight2 = _interopRequireDefault(_FixedHeight);
	
	var _SpringConfig = __webpack_require__(184);
	
	var _SpringConfig2 = _interopRequireDefault(_SpringConfig);
	
	var _Nested = __webpack_require__(185);
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'h2',
	          null,
	          'Example 1. Variable text'
	        ),
	        _react2['default'].createElement(_VariableText2['default'], null)
	      ),
	      _react2['default'].createElement(
	        'section',
	        { style: style.section },
	        _react2['default'].createElement(
	          'h2',
	          null,
	          'Example 2. Variable height content'
	        ),
	        _react2['default'].createElement(_VariableHeight2['default'], null)
	      ),
	      _react2['default'].createElement(
	        'section',
	        { style: style.section },
	        _react2['default'].createElement(
	          'h2',
	          null,
	          'Example 3. Fixed Collapse height'
	        ),
	        _react2['default'].createElement(_FixedHeight2['default'], null)
	      ),
	      _react2['default'].createElement(
	        'section',
	        { style: style.section },
	        _react2['default'].createElement(
	          'h2',
	          null,
	          'Example 4. Custom spring configuration'
	        ),
	        _react2['default'].createElement(_SpringConfig2['default'], null)
	      ),
	      _react2['default'].createElement(
	        'section',
	        { style: style.section },
	        _react2['default'].createElement(
	          'h2',
	          null,
	          'Example 5. Nested Collapse'
	        ),
	        _react2['default'].createElement(_Nested2['default'], null)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shallowCompare = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _textJson = __webpack_require__(180);
	
	var _textJson2 = _interopRequireDefault(_textJson);
	...
	var getText = function getText(num) {
	  return _textJson2['default'].slice(0, num).map(function (p, i) {
	    return _react2['default'].createElement(
	      'p',
	      { key: i },
	      p
	...
	var VariableText = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var paragraphs = _state.paragraphs;
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        '  Paragraphs:  ',
	        _react2['default'].createElement('input', { type: 'range', step: 1, min: 0, max: 4,
	          value: paragraphs, onChange: this.onChange })
	      ),
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: style.container },
	        _react2['default'].createElement(
	          'div',
	          { style: { padding: 10 } },
	          paragraphs ? getText(paragraphs) : _react2['default'].createElement(
	            'p',
	            null,
	            'No text'
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Collapse = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactHeight = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components2 = __webpack_require__(162);
	
	var _components3 = _interopRequireDefault(_components2);
	
	var _reorderKeys = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noVelocity = __webpack_require__(163);
	
	var _noVelocity2 = _interopRequireDefault(_noVelocity);
	
	var _hasReachedStyle = __webpack_require__(164);
	
	var _hasReachedStyle2 = _interopRequireDefault(_hasReachedStyle);
	
	var _mergeDiff = __webpack_require__(165);
	
	var _mergeDiff2 = _interopRequireDefault(_mergeDiff);
	
	var _animationLoop = __webpack_require__(166);
	
	var _animationLoop2 = _interopRequireDefault(_animationLoop);
	
	var _zero = __webpack_require__(170);
	
	var _zero2 = _interopRequireDefault(_zero);
	
	var _updateTree = __webpack_require__(171);
	
	var _deprecatedSprings2 = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactHeight = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var localStyle = function localStyle(height) {
	  return {
	    content: {
	      height: height,
	...
	var VariableHeight = _react2['default'].createClass({
	  displayName: 'VariableHeight',
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        '  Content height:  ',
	        _react2['default'].createElement('input', { type: 'range', step: 50, min: 0, max: 500,
	          value: height, onChange: this.onChange })
	      ),
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: style.container },
	        _react2['default'].createElement('div', { style: _extends({}, localStyle(height).content, { height: height }) })
	      )
	    );
	  }
	});
	
	exports['default'] = VariableHeight;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedHeight = _react2['default'].createClass({
	  ...
	  onChangeContent: function onChangeContent(_ref) {
	    var value = _ref.target.value;
	
	    this.setState({ content: parseInt(value, 10) });
	  },
	
	  onChangeCollapse: function onChangeCollapse(_ref2) {
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: style.container, fixedHeight: collapse },
	        _react2['default'].createElement('div', { style: _extends({}, localStyle(content).content, { height: content }) })
	      )
	    );
	  }
	});
	
	exports['default'] = FixedHeight;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VariableHeight = _react2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    var _presets$stiff = _slicedToArray(_reactMotion.presets.stiff, 2);
	
	    var stiffness = _presets$stiff[0];
	    var damping = _presets$stiff[1];
	
	    return { isOpened: false, height: 100, stiffness: stiffness, damping: damping };
	  },
	  ...
	  onChange: function onChange(prop) {
	    ...
	    return function (_ref) {
	      var value = _ref.target.value;
	      return _this.setState(_defineProperty({}, prop, parseInt(value, 10)));
	    };
	  },
	  ...
	  render: function render() {
	    ...
	    var isOpened = _state.isOpened;
	    var height = _state.height;
	    var stiffness = _state.stiffness;
	    var damping = _state.damping;
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'button',
	          { onClick: function () {
	              return _this2.setState({ isOpened: !isOpened });
	            } },
	          'Toggle'
	        ),
	        '  Content height:  ',
	        _react2['default'].createElement('input', { type: 'range', min: 100, max: 500, step: 50,
	          value: height, onChange: this.onChange('height') }),
	        '  Stiffness:  ',
	        _react2['default'].createElement('input', { type: 'range', min: 0, max: 300, step: 10,
	          value: stiffness, onChange: this.onChange('stiffness') }),
	        '  Damping:  ',
	        _react2['default'].createElement('input', { type: 'range', min: 0, max: 40, step: 5,
	          value: damping, onChange: this.onChange('damping') })
	      ),
	      _react2['default'].createElement(
	        _2['default'],
	        { isOpened: isOpened, style: style.container, springConfig: [stiffness, damping] },
	        _react2['default'].createElement('div', { style: _extends({}, localStyle(height).content, { height: height }) })
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nested = _react2['default'].createClass({
	  displayName: 'Nested',
